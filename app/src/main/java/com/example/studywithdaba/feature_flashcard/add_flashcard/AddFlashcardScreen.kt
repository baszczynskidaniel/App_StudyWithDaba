...
fun AddFlashcardScreen(
    ...
    onEvent: (AddFlashcardEvent) -> Unit,
    ...
    AddFlashcardScreen(
        ...
        onBack = { onEvent(AddFlashcardEvent.OnBack(navController)) },
        onFavouriteChange = { onEvent(AddFlashcardEvent.OnFavouriteChange(it)) },
        onDefinitionChange = { onEvent(AddFlashcardEvent.OnDefinitionChange(it)) },
        onDefinitionClear = { onEvent(AddFlashcardEvent.OnDefinitionClear) },
        onAnswerChange = { onEvent(AddFlashcardEvent.OnAnswerChange(it)) },
        onAnswerClear = { onEvent(AddFlashcardEvent.OnAnswerClear) },
        onShowAllDecksChange = { onEvent(AddFlashcardEvent.OnShowAllDecksChange(it)) },
        onInputDeckClick = { onEvent(AddFlashcardEvent.OnInputDeckClick(it)) },
        onFilterDeckClick = { deck, selectedChange -> onEvent(AddFlashcardEvent.OnFilterDeckClick(deck, selectedChange)) },
        onSwap = { onEvent(AddFlashcardEvent.OnSwap) },
        onAutoMoveChange = { onEvent(AddFlashcardEvent.OnAutoMoveChange(it)) },
        onAddFlashcard = { onEvent(AddFlashcardEvent.OnAddFlashcard)}
    )
}
