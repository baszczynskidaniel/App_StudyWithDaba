...
interface NoteDao {
    ...
    @Query("update note set content = :content, lastEdited = :lastEdited, contentStyle = :contentStyle where noteId = :noteId")
    suspend fun updateNoteContentByNoteId(noteId: Long, content: String, contentStyle: String, lastEdited: Long )
