...
class DeckRepositoryImpl @Inject constructor(
    ...
    override fun getDecksInFlashcard(flashcardId: Long): Flow<List<Deck>> {
        return deckDao.getDecksInFlashcard(flashcardId)
    }
    ...
    override suspend fun updateDeckFavourite(deckId: Long, favourite: Boolean) {
